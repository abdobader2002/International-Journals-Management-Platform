     ...
     <tr>
       ...
       <th style="text-align: center;">Actions</th>
        ...
        <?php 
            ...
            FROM submissions s
            JOIN assignment_editor ae ON s.id = ae.artical_id
            WHERE ae.editor_id = '$editor_id'";
   ...
   <tbody style="font-size: medium; text-align: center;">
    <tr>
        ...
        <td style="text-align: center;">
            <form action="Editor_Assign_Reviewer.php?artical_id=<?php echo $row['id']; ?>" class="for" method="post" style="display:block;">
                <input type="submit" name="submit" value="Send for Review" style="padding:4 20px;">
            </form>
            <form action="Accept_and_Skip_Review.php?artical_id=<?php echo $row['id']; ?>" class="for" method="post" style="display:block;">
            <input type="submit" name="Accept" value="Accept and Skip Review" style="padding:4 20px;" onclick="return confirm('Are you sure you want to accept and skip review of this article?')">
            </form>
        </td>
      </tr>
      <?php
