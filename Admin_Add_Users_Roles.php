...
<form method="post" action="Admin_Add_Users_Roles.php">
...
<fieldset class="identity">
    ...
    <input type="text" class="form-control" name="givenName" id="Name" value="" maxlength="32" placeholder="Enter your first name">
    <br>
    <input type="text" class="form-control" name="familyName" id="Name" value="" maxlength="32" placeholder="Enter your secon name">
    ...
    <br>
    <br>
    <input type="text" class="form-control" name="username" id="Name" value="" maxlength="32" placeholder="Enter your user name">
...
<input type="text" class="form-control" name="email" id="Contact" value="" maxlength="32" placeholder="Enter your email">
<br>
<span>Role</span>
<select name="user_roles" class="form-control" id="country" autocomplete="country-name" required aria-required="true" style="height: 35px;cursor: pointer;">
    <option></option>
...
<input type="text" class="form-control" name="Password" id="Contact" value="" maxlength="32" placeholder="Enter your Password">
<br>
<input type="text" class="form-control" name="Repeat_Password" id="Contact" value="" maxlength="32" placeholder="Repeat Password">
<br>
<br>
<div class="register-1c">
   ...
   background: #fff;
       ...
       <button class="span-login" type="submit" name="submit" >OK</button>
       <style>
           .span-login{
               float: right;
   margin-right: 10px;
