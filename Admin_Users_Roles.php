...
<nav class="cmp_breadcrumbs" role="navigation" aria-label="You are here:">
    <ol class="breadcrumb">
        ...
        <a style="font-size: large; margin-left: 5px; " class="fas fa-arrow-left" href="Admin_submmisions.php" > Back To Subnission</a>
            ...
            <a href="Admin_Add_Users_Roles.php"><Button class="form" >Add User</Button></a>
        </form>
        </li>
    </ol>
</nav>
...
.for{
 ...
 <table id="usersTable">
   ...
   UNION
   SELECT id,givenname,FamilyName,username,email, role FROM reviwers WHERE user_id='$user_id'";
   $result = mysqli_query($conn, $query);
   if ($result) {
     while ($row = mysqli_fetch_assoc($result)) {
   ?>
    <tr>
        <td style="text-align: center;"><?php echo $gname=$row['givenname']; ?></td>
